...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, GnUiLinkifyDirectiveHDF],
})
class TestComponent {
  text = ''
...
describe('GnUiLinkifyDirectiveHDF', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [GnUiLinkifyDirectiveHDF, TestComponent],
    })
  ...
  function getAnchorElement() {
    debugElement = fixture.debugElement.query(
      By.directive(GnUiLinkifyDirectiveHDF)
    )
