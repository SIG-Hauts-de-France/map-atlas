...
describe('MetadataInfoHDFComponent', () => {
  let component: MetadataInfoHDFComponent
  let fixture: ComponentFixture<MetadataInfoHDFComponent>
  ...
  describe('When a section is empty', () => {
    beforeEach(() => {
      fixture = TestBed.createComponent(MetadataInfoHDFComponent)
