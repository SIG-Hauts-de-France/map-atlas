...
describe('ThumbnailHDFComponent', () => {
  let component: ThumbnailHDFComponent
  let fixture: ComponentFixture<ThumbnailHDFComponent>
  let de: DebugElement

  beforeEach(async () => {
    await TestBed.overrideComponent(ThumbnailHDFComponent, {
      set: { changeDetection: ChangeDetectionStrategy.Default },
    }).compileComponents()
  })

  beforeEach(() => {
    fixture = TestBed.createComponent(ThumbnailHDFComponent)
