...
export const THUMBNAIL_HDF_PLACEHOLDER = new InjectionToken<string>(
...
@Component({
  selector: 'gn-ui-thumbnail-hdf',
  templateUrl: './thumbnail-hdf.component.html',
...
export class ThumbnailHDFComponent implements OnInit, OnChanges {
  ...
  imgUrl: string
  imgFit: FitOptions
  placeholderUrl = this.optionalPlaceholderUrl || DEFAULT_PLACEHOLDER_HDF
  get isPlaceholder() {
  ...
  constructor(
    @Optional()
    @Inject(THUMBNAIL_HDF_PLACEHOLDER)
