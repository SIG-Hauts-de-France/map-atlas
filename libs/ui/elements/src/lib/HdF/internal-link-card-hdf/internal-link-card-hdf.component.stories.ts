...
import { InternalLinkCardHDFComponent } from './internal-link-card-hdf.component'
...
export default {
  title: 'Elements/InternalLinkCardHDFComponent',
  component: InternalLinkCardHDFComponent,
  decorators: [
    applicationConfig({
      providers: [
...
} as Meta<InternalLinkCardHDFComponent>

type InternalLinkCardHDFComponentWithFavoriteTemplate =
InternalLinkCardHDFComponent & {
    favoriteTemplateString: string
  }

export const RecordCard: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    argTypes: {
      size: {
        control: 'radio',
...
export const AllSizeOfCards: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
    },
...
export const LargeCardWithSmallContent: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
      size: 'L',
...
export const MediumCard: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
      size: 'M',
...
export const SmallCard: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
      size: 'S',
...
export const ExtraSmallCard: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
      size: 'XS',
...
export const WithoutQualityMetrics: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
...
export const MultipleLargeCards: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
    },
...
export const LargeCardWithoutContact: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
      size: 'L',
...
export const MediumCardWithoutContact: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
      size: 'M',
...
export const MediumCardsSquashed: StoryObj<InternalLinkCardHDFComponentWithFavoriteTemplate> =
  {
    args: {
      ...RecordCard.args,
    },
