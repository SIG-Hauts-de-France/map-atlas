...
describe('InternalLinkCardComponent', () => {
  let component: InternalLinkCardHDFComponent
  let fixture: ComponentFixture<InternalLinkCardHDFComponent>
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      .overrideComponent(InternalLinkCardHDFComponent, {
        set: { changeDetection: ChangeDetectionStrategy.Default },
      })
      .compileComponents()

    fixture = TestBed.createComponent(InternalLinkCardHDFComponent)
