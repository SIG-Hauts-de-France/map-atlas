...
@Component({
  selector: 'gn-ui-internal-link-card-hdf',
  standalone: true,
  imports: [
    NgClass,
    NgIf,
  ...
  templateUrl: './internal-link-card-hdf.component.html',
  styleUrls: ['./internal-link-card-hdf.component.scss'],
})
export class InternalLinkCardHDFComponent implements OnInit {
