...
@Component({
  selector: 'gn-ui-record-preview-feed-hdf',
  templateUrl: './record-preview-feed-hdf.component.html',
  styleUrls: ['./record-preview-feed-hdf.component.css'],
...
export class RecordPreviewFeedHdFComponent extends RecordPreviewComponent {
