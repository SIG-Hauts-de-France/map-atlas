...
describe('RecordPreviewFeedComponent', () => {
  let component: RecordPreviewFeedHdFComponent
  let fixture: ComponentFixture<RecordPreviewFeedHdFComponent>
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(RecordPreviewFeedHdFComponent)
