...
import { RecordPreviewFeedHdFComponent } from './record-preview-feed-hdf.component'
...
export default {
  ...
  component: RecordPreviewFeedHdFComponent,
  decorators: [
    moduleMetadata({
...
} as Meta<RecordPreviewFeedHdFComponent>

type RecordPreviewFeedTemplate = RecordPreviewFeedHdFComponent & {
...
export const Primary: StoryObj<RecordPreviewFeedTemplate> = {
  ...
  render: (args) => ({
    ...
    template: `<gn-ui-record-preview-feed-hdf
      [record]='record'
      [linkTarget]='linkTarget'
      (mdSelect)='mdSelect'
      [favoriteTemplate]='favorite'>
    </gn-ui-record-preview-feed-hdf>
