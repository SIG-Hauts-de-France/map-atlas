...
import { RecordPreviewRowHDFComponent } from './record-preview-row-hdf.component'
import { CatalogRecord } from '@geonetwork-ui/common/domain/model/record'

describe('RecordPreviewDatahubComponent', () => {
  let component: RecordPreviewRowHDFComponent
  let fixture: ComponentFixture<RecordPreviewRowHDFComponent>
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(RecordPreviewRowHDFComponent)
