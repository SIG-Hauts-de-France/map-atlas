...
import { ResultsTableHdFComponent } from '@geonetwork-ui/ui/search'
...
@Component({
  selector: 'gn-ui-results-table-hdf-container',
  templateUrl: './results-table-hdf-container.component.html',
  styleUrls: ['./results-table-hdf-container.component.css'],
  standalone: true,
  imports: [CommonModule, ResultsTableHdFComponent],
})
export class ResultsTableHdFContainerComponent implements OnDestroy {
