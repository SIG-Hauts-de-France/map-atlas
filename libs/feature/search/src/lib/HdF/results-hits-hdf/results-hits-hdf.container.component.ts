...
@Component({
  selector: 'gn-ui-results-hits-hdf',
  templateUrl: './results-hits-hdf.container.component.html',
  styleUrls: ['./results-hits-hdf.container.component.css'],
  standalone: true,
  imports: [
    CommonModule,
    ResultsHitsNumberComponent,
...
export class ResultsHitsHdFContainerComponent implements OnInit {
