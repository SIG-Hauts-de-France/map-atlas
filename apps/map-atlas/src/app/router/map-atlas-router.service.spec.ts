...
import { MapAtlasRouterService } from './map-atlas-router.service'
...
describe('MapAtlasRouterService', () => {
  let service: MapAtlasRouterService
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(MapAtlasRouterService)
  })
